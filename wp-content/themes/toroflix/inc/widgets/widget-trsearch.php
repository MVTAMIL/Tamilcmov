        ...
        <div class="SearchMovies">
            <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" id="trfilter" autocomplete="off">
                ...
                <div class="Frm-Slct" id="trfilterdirectors">
                    <label class="AAIco-videocam"><?php _e('Directors', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
                ...
                <div class="Frm-Slct" id="trfiltercast">
                    <label class="AAIco-person"><?php _e('Cast', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
                ...
                <div class="Frm-Slct" id="trfiltercountries">
                    <label class="AAIco-videocam"><?php _e('Country', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
                ...
                <!--<select>-->
                <div class="Frm-Slct">
                    <label class="AAIco-movie_creation"><?php _e('Genres', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
                ...
                <!--<select>-->
                <div class="Frm-Slct">
                    <label class="AAIco-equalizer"><?php _e('Quality', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
                ...
                <!--<select>-->
                <div class="Frm-Slct">
                    <label class="AAIco-language"><?php _e('Language', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
                ...
                <!--<select>-->
                <div class="Frm-Slct">
                    <label class="AAIco-storage"><?php _e('Server', 'toroflix'); ?></label>
                    <div class="Form-Group">
                        <?php
